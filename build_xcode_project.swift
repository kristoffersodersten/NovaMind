...
struct XcodeProjectBuilder {
    ...
    private func generateBasicPBXContent() -> String {
        let fileReferences = generateFileReferences()
        let groups = generateGroups()
        let targets = generateTargets()
        let project = generateProject()
        let configurations = generateConfigurations()
    ...
    private func generateFileReferences() -> String {
        return """
        \t\t67000001 = {
    ...
    private func generateGroups() -> String {
        return """
        \t\t67000002 = {
        \t\t\tisa = PBXGroup;
        \t\t\tchildren = (
    ...
    private func generateTargets() -> String {
        return """
        \t\t67000013 = {
        \t\t\tisa = PBXNativeTarget;
        \t\t\tname = \(projectName);
    ...
    private func generateProject() -> String {
        return """
        \t\t67000017 = {
        \t\t\tisa = PBXProject;
    ...
    private func generateConfigurations() -> String {
        return """
        \t\t67000018 = {
